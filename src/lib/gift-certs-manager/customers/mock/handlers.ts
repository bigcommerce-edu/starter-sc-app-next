import { customerDetailMockHandler } from "@/lib/gift-certs-manager/customers/mock/customer-detail-handler";
...
export const customersMockHandlers: MockRouteHandler[] = [customerDetailMockHandler, customersListMockHandler];
